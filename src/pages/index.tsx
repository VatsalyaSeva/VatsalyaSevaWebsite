...
const Home:NextPage = ()=> {
    ...
    return (
        <UserLayout>
            <div className=''>
                <Slider />
                <div className='w-full grid lg:flex-rows-2 flex-cols-2 items-center lg:px-10 lg:py-5 lg:space-x-10 space-y-3 px-2 py-5 mt-5'>
                ...
                <div className='px-3 py-5 flex flex-col lg:flex-row justify-center items-center mt-4'>
